...
import { Actor, CategoriasDAOService, CategoriasViewModelService } from './servicios.service';
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [NotificationService, LoggerService,
          {
            provide: CategoriasDAOService, useFactory: () => new DAOServiceMock<Actor, number>([...dataMock])
          }
        ],
      });
